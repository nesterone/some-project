...
export const MainLayout = React.forwardRef(
  ({ title, sidebar, content, paginationHandler }, ref) => {
    return (
      <>
        <Header />
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="flex flex-col">
                ...
                <button
                  ...
                  className="mt-7 cursor-pointer rounded-lg bg-lightBlue py-2.5 text-2xl font-bold text-white hover:text-tmdbDarkBlue sm:ml-[30px]"
                >
                  Load More
                </button>
              </div>
